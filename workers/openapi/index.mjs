const descriptor = {
  ...
  paths: {
    ...
    "/planetscaleAi/listTablesForDatabaseByName": {
      get: {
        ...
        responses: {
          200: {
            description:
              "List of table names (see \\[ListTableNamesResponse\\]).",
            content: {
              "application/json": {
                schema: {
    ...
    "/planetscaleAi/naturalLanguageSQLQuery": {
      get: {
        summary:
          "Accepts a natural language prompt, translates the prompt to an SQL query, and runs the query; returns the results.",
        description:
        ...
        parameters: [
          {
            ...
            in: "query",
            description:
              "Optional database name; can be withheld if there is only one database to query. Databases can be listed via \\[planetscaleDatabaseNamesList\\].",
            schema: {
              type: "string",
              nullable: true,
            },
        ...
        responses: {
          200: {
            description:
              "Successful response indicating columns and rows of a resultset from the query",
            content: {
              "application/json": {
                schema: {
    ...
    "/planetscaleAi/tableSchemaByName": {
      get: {
        ...
        responses: {
          200: {
            description:
              "HTTP response containing JSON which describes the table.",
            content: {
              "application/json": {
                schema: {
